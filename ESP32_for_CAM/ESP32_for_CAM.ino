//FROM https://github.com/perldj/ESP32CAMToS3/blob/master/UploadToS3.ino
//Description https://www.youtube.com/watch?v=FIPkU-gx_kU&t=1s
...
//  image.toCharArray(image_char, str_len);
  ...
  esp_http_client_config_t config_client = {0};
   ...
   String post_url2 = "https://xjes44kiea.execute-api.ap-northeast-2.amazonaws.com/hudadak/"; // Location where images are POSTED
